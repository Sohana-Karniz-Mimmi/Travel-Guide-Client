            ...
            <div className="barlow-regular w-full mx-auto group rounded border-2 lg::w-[365px]">
                ...
                <div className="p-6 space-y-2">
                    ...
                    <div className="flex justify-between">
                        <span className="text-gray-700 flex items-center gap-2"><IoLocationOutline className='text-black' /> countryName, </span>
                        <h3 className="z-10 bg-green-600 text-sm font-medium text-white rounded-md py-1 px-[10px] xs:text-xl md:text-sm flex items-center gap-2">Sports</h3>
                    </div>
                    <div className="text-gray-500 text-[15px]">
                        <p className='flex items-center gap-2'>description.slice0, 135</p>
                    </div>
                    ...
                    <Link to={`/details`} className=" w-full relative p-0.5 inline-flex items-center justify-center font-bold overflow-hidden transition-all ease-out duration-300 rounded-md">
