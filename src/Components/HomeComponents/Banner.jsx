...
import slider4 from '../../assets/images/Banner Slider/banner4.jpeg'
                    ...
                    >
                        ...
                        <div className='flex items-center justify-center md:h-[540px] h-[350px]'>
                            <div className=" text-white mx-auto md:max-w-[820px] text-center ltr:sm:text-left rtl:sm:text-right p-10 rounded-lg">
                                ...
                                Find your dream job effortlessly. Explore countless opportunities and streamline your job search with our intuitive platform
                                </p>
