        ...
        <div>
            <div className="barlow-regular w-full mx-auto group rounded border-2 lg::w-[365px]">
                ...
                <div className="p-6 space-y-2">
                    ...
                    <Link to={`/details/${_id}`} className=" w-full relative p-0.5 inline-flex items-center justify-center font-bold overflow-hidden transition-all ease-out duration-300 group-hover:bg-[#FD4C5C] rounded-md">
