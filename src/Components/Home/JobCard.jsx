      ...
      <div>
        ...
        <div className='flex justify-between items-center'>
          ...
          <div className=' text-center'>
            {
              user ? <Link to={`/job/${_id}`} className="md:px-4 md:py-2 px-3 py-2 border hover:bg-[#FD4C5C] group-hover:text-white duration-300 border-[#FD4C5C] hover:border-[#FD4C5C] text-center transition-all ease-out md:text-[16px] text-sm btn-outline rounded-md hover:outline-none bg-[#FD4C5C] text-white">View Details</Link> : <Link to={`/job/${_id}`} onClick={showToast} className="md:px-4 md:py-2 px-3 py-2 border hover:bg-[#FD4C5C] group-hover:text-white duration-300 border-[#FD4C5C] hover:border-[#FD4C5C] text-center transition-all ease-out md:text-[16px] text-sm btn-outline rounded-md hover:outline-none bg-[#FD4C5C] text-white">View Details</Link>
            }
          </div>
